...
function result() {
    ...
    var xLocation = newStory.indexOf(":insertx");
    var yLocation = newStory.indexOf(":inserty:");
    var zLocation = newStory.indexOf(":insertz:");


    newStory = newStory.replace(xLocation, xItem);
    newStory = newStory.replace(yLocation, yItem);
    newStory = newStory.replace(zLocation, zItem);

    /* STEP 10: If the user has typed a name in the customName field, replace the name 'Bob' in the story with whatever they typed */
    var customNameLocation = newStory.indexOf("Bob");
    newStory = newStory.replace(customNameLocation, customNameInput);
    ...
    if (document.getElementById("metric").checked) {
        ...
        var weightLocation = storyText.indexOf("300 pounds");
        newStory = storyText.replace(weightLocation, weight + "kgs");
        ...
        var tempLocation = storyText.indexOf("94 fahrenheit");
        newStory = storyText.replace(tempLocation, temp + "celsuis");
    }
